...
const copyArrays = [...pointsList1, ...pointsList2];
...
const copyObjects = {...toy2, ...toyUpdate};
...
/* const copyColors2 = [...colors.slice(0,2), ...colors.slice(3)];
console.log(copyColors2); */

/* const copy2 = [...colors];
const copyColors = [...copy2.splice(0,2), ...copy2.splice(1)];
