...
const searchNumber = numbers.find((number) => number === 100);
...
const movieOfTheYear = movies.find((movie) => movie.date === 2010);
...
const fusionOfAliens = {...findAlien, mutation: {...findMutation}};
console.log(fusionOfAliens);

console.log(aliens.find((alien) => alien.name === 'Cucushumushu'), mutations.find((mutation) => mutation.name === 'Porompompero'));
const alien = {...aliens.find((alien) => alien.name === 'Cucushumushu'), mutation: {...mutations.find((mutation) => mutation.name === 'Porompompero')}};
console.log(alien);
